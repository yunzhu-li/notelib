...
public class NBSimpleAdapter extends SimpleAdapter {
    ...
    public NBSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
    ...
    public void setViewBinder(ViewBinder viewBinder) {
        ViewBinder viewBinder2 = new ViewBinder() {
             ...
             *
             * When binding is handled by this ViewBinder, this method must
             * return true. If this method returns false, SimpleAdapter will
             * attempts to handle the binding on its own.
             *
             * @param view
             ...
             *            a safe String representation of the supplied data: it
             *            is either the result of data.toString() or an empty
             *            String but it is never null
             *
