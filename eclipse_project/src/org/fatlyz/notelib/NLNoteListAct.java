...
public class NLNoteListAct extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLstNotes.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                // Clear last
                if (mLastVisitedNotePos != -1) {
                    mAListNotes.get(mLastVisitedNotePos).put("ItemLastVisited", R.color.c_transparent);
                }
                // Set new
            ...
            public void onClick(View arg0) {
                ...
                final Handler loadThumbHandler = new Handler() {
                    ...
                    public void dispatchMessage(Message msg) {
                        ...
                        /*
                         * try{ ImageView _img = ((ImageView)
                         * mLstNotes.getChildAt(msg.what -
                         * mLstNotes.getFirstVisiblePosition
                         * ()).findViewById(R.id.lstNotesItemIcon));
                         * _img.setVisibility(ImageView.INVISIBLE);
                         * _img.startAnimation
                         * (AnimationUtils.loadAnimation(NLNoteListAct.this,
                         * R.anim.lists_fade_in));
    ...
    private void loadBookmarkList() {
        ...
        while (_iter.hasNext()) {
            ...
            if (!_key.contains("_")) {
                ...
                /**
                 * Format: #BEGIN# !note!2932!中国1975版2 Yuan纸钞!Pick
                 * NL!1975!http://ybnotes.com/spic/d/file/banknotes/asia/China/
                 * 200911415224239057.jpg! #END#
                 */
                _tmpData += "\n!note!" + _key + "!" + spMap.get(_key + "_name") + "!" + spMap.get(_key + "_catanum") + "!" + spMap.get(_key + "_edition") + "!"
            ...
            public void run() {
                ...
                try {
                    ...
                    if (mLoadMode.equals("Country")) {
                        mDataStr = mNetUtils.fetchString(
                                "https://api.yunzhu.org/apps/notelib/mobile/notelist.php?key=gEWQ41lf5z9sLx2m&country=" + URLEncoder.encode(mCountryName, "UTF-8"),
                                new Handler());

                    } else if (mLoadMode.equals("New")) {
                        mDataStr = mNetUtils.fetchString("https://api.yunzhu.org/apps/notelib/mobile/notelist_newnotes.php?key=LbpzdRZwotFm2Mnc", new Handler());

                    } else if (mLoadMode.equals("Search")) {
                        mDataStr = mNetUtils.fetchString(
                                "https://api.yunzhu.org/apps/notelib/mobile/notelist_search.php?key=B3Ho1dT521lsfVg7" + "&keyword="
                                        + URLEncoder.encode(mSearchKeyword, "UTF-8") + "&clientver=" + URLEncoder.encode(getString(R.string.app_ver), "UTF-8")
                                        + "&phonemodel=" + URLEncoder.encode(android.os.Build.BRAND + " - " + android.os.Build.MODEL, "UTF-8"), new Handler());
                    }
                    if (mDataStr != null) {
    ...
    private void dispatchNoteListData(String dataStr) {
        ...
        // Create Adapter
        mLstNotesAdapter = new NBSimpleAdapter(this, mAListNotes, // Data Source
                R.layout.lstitem_note, // ListItem Layout XML
                new String[] { // SubItems
                "ItemID", "ItemIcon", "ItemTitle", "ItemPickNum", "ItemEdition", "ItemLastVisited", "ItemThumbURL" }, new int[] { R.id.lstNotesItemID,
                        R.id.lstNotesItemIcon, R.id.lstNotesItemTitle, R.id.lstNotesItemSubtitle1, R.id.lstNotesItemSubtitle2,
                        R.id.lstNotesItem_imgLastVisited, 0 });
        // Set ViewBinder
            ...
            if (mDispatchedNotesSum < 300) {
                if (mDispatchedNotesSum == 0) {
                    ...
                    Toast.makeText(NLNoteListAct.this,
                            getString(R.string.common_search_result_0) + mDispatchedNotesSum + getString(R.string.common_search_result_1), Toast.LENGTH_SHORT)
                            .show();
                }
            } else {
    ...
    private void dispatchNoteListDataLine(char[] line) {
        ...
        int _lineLength = line.length; // Log.d("Line Length:", "" +
                                       // _lineLength);
                ...
                if (mLstNotesAdapter.mToLoadThumbItemList.size() > 0) {
                    ...
                    if (_tmpImgData != null) {
                        ...
                        if (mBmpThumbs.get(mBmpCount) == null) {
                            ...
                            // Write DB
                            nDBUtils.InsertBinaryData((String) mAListNotes.get(mLstNotesAdapter.mToLoadThumbItemList.get(0)).get("ItemID"),
